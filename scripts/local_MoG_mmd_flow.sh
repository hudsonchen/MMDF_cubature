...
do
  ...
  do
    /home/zongchen/miniconda3/envs/mmd_cubature/bin/python main.py --seed $seed --particle_num $particle_num --dataset mog --step_size 0.1 --bandwidth 1.0 --inject_noise_scale 0.0 --step_num 100000
  done
done