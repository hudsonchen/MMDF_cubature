...
#     done
  for particle_num in 1000
    do
        /home/zongchen/miniconda3/envs/mmd_cubature/bin/python sp.py --seed $seed --particle_num $particle_num --dataset elevators --step_size 1.0 --bandwidth 1.0 --step_num 100000
    done
done
